...
const tool = {
  url: {
    ...
    qc: {
      ...
      resumeSearch: { //简历搜索
        ...
        t: "get",
        pathname:"/Candidate/SearchResumeIndexNew.aspx"
      },
      resumeDetail: {  //简历详情
        u: "https://ehire.51job.com/Candidate/ResumeView.aspx",
        t: "get",
        pathname:"/Candidate/ResumeView.aspx"
      },
      resumeDetailFolder: {  //收件箱简历
      ...
      resumeSearchResult: {  //简历搜索结果
        ...
        t: 'get',
        pathname:"/Candidate/SearchResumeNew.aspx"
      },
      searchExternalPosition:{ //搜索外网职位
    ...
    lg:{
      resumeSearch:{
        ...
        u:'https://easy.lagou.com/talent/index.htm',
        t:'get'
      },
      resumeDetail:{
        // u:'https://easy.lagou.com/search/resume',
        u:'https://easy.lagou.com/talent/search/list.htm',
        t:'get'
      },
      resumeDetail2:{
      ...
      resumeDetail3:{
        u:'https://easy.lagou.com/v2/resumeDetailSign',
        t:'get'
      },
    ...
    lp:{
      ...
      positionRelease:{
        u:"https://lpt.liepin.com/ejobedit/editsocietyejob?ejobActionType=publish",
        t:"get"
      }
    },
    cjol:{
    ...
    zb:{
      resumeSearch:{
        u:"https://hire.jobcn.com/search/",
        t:"get",
      },
      resumeSearchId:{
        u:"https://hire.jobcn.com/search/searchquick.jsp",
        t:"get",
        pathname:"/search/searchquick.jsp"
      },
      resumeDetail:{
        u:"https://hire.jobcn.com/search/view.xhtml",
        t:"get",
        pathname:"/search/view.xhtml"
      },
      resumeSearchResult:{
        u:"https://hire.jobcn.com/search/result.xhtml",
        t:"get",
        pathname:"/search/result.xhtml"
      },
      searchExternalPosition:{
        // u:"https://www.jobcn.com/search/result.xhtml",
        u:"https://www.jobcn.com/search/result.xhtml?s=search%2Ftop&p.includeNeg=0&p.sortBy=postdate&p.jobLocationId=&p.jobLocationTown=&p.jobLocationTownId=&p.querySwitch=0p.keywordType=2&p.workLocation=",
        t:"get"
      },
      positionRelease: {
        u: 'http://hire.jobcn.com/company/companyJob/pubPos.xhtml',
        t: 'get'
      },
      positionList:{
        u:"http://hire.jobcn.com/company/companyJob/refreshPosStatistics.xhtml",
        t:"get"
      }
    }
  },
  ...
  ajaxUrl: type?'https://www.ivvajob.com':'http://localhost:8080',  //外网IP
